...
In the following snippet, replace `[name]` with the actual name of the project you need. **Using Java 1.6 or 1.7?** Add `-legacy` after the name of the project. See [below](#which-java) why. **Using Play 2.3?** Use `0.2.1` version since `0.2.1` and up will target Play 2.4.

**build.sbt**

```scala
libraryDependencies ++= Seq(
  "com.pauldijou" %% "[name]" % "0.2.1"
)
```
...
```scala
libraryDependencies ++= Seq(
  "com.pauldijou" %% "jwt-play-legacy" % "0.2.1"
)
```
